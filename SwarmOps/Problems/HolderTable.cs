...
namespace SwarmOps.Problems
{
    ...
    public class HolderTable : BenchmarkProblem
    {
        ...
        public HolderTable(int dimensionality, int maxIterations)
        ...
        /// </summary>
        public override string Name => "HolderTable";
        ...
        public override double Fitness(double[] x)
        {
            ...
            double fact2 = Math.Exp(Math.Abs(1 - Math.Sqrt((int)x1 ^ 2 + (int)x2 ^ 2) / Math.PI));
