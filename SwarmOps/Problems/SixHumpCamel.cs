...
namespace SwarmOps.Problems
{
    ...
    public class SixHumpCamel: BenchmarkProblem
    {
        #region Constructors.
        ...
        public SixHumpCamel(int dimensionality, int maxIterations)
        ...
        /// </summary>
        public override string Name => "SixHumpCamel";
        ...
        public override double Fitness(double[] x)
        {
            ...
            double x1 = x[0];
            double x2 = x[1];
            double term1 = (Math.Pow(4 - 2.1 * x1, 2) + Math.Pow(x1, 4) / 3) * Math.Pow(x1, 2);
            double term2 = x1 * x2;
            double term3 = (Math.Pow(-4 + 4 * x2, 2)) * Math.Pow(x2, 2);
