...
namespace SwarmOps.Problems
{
    ...
    public class DropWave : BenchmarkProblem
    {
        #region Constructors.
        ...
        public DropWave(int dimensionality, int maxIterations)
        ...
        /// </summary>
        public override string Name => "DropWave";

        /// <summary>
        /// Minimum possible fitness.
        /// </summary>
        public override double MinFitness => -5.12;
        ...
        public override double Fitness(double[] x)
        {
            ...
            double frac1 = 1 + Math.Cos(12 * Math.Sqrt((int)x1 ^ 2 + (int)x2 ^ 2));
            double frac2 = 0.5 * ((int)x1 ^ 2 + (int)x2 ^ 2) + 2;
            return -frac1 / frac2;
        }
