...
namespace SwarmOps.Problems
{
    ...
    public class Grammacy : BenchmarkProblem
    {
        #region Constructors.
        ...
        public Grammacy(int dimensionality, int maxIterations)
        ...
        /// </summary>
        public override string Name => "Grammacy";
        ...
        public override double Fitness(double[] x)
        {
            ...
            double fact1 = x1;
            double fact2 = Math.Exp(Math.Pow(-x1, 2) - Math.Pow(x2, 2));
            return fact1 * fact2;
        }
