...
namespace SwarmOps.Problems
{
    ...
    public class Michaelwicz : Benchmark
    {
        #region Constructors.
        ...
        public Michaelwicz(int dimensionality, int maxIterations)
        ...
        /// </summary>
        public override string Name => "Michaelwicz";
        ...
        public override double Fitness(double[] x)
        {
            ...
            {
                double xi = x[ii];
                int result1 = (int)(ii * xi) ^ 2;
                int result2 = (int)(Math.Sin(result1 / Math.PI)) ^ (2 * m);
                double n = Math.Sin(xi) * result2;
                sum = sum + n;
            }
            return -sum;
        }
